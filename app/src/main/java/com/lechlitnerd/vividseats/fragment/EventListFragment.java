package com.lechlitnerd.vividseats.fragment;
...
import com.lechlitnerd.vividseats.adapter.EventListAdapter;
import com.lechlitnerd.vividseats.constant.RequestConstants;
import com.lechlitnerd.vividseats.handler.IResponseHandler;
import com.lechlitnerd.vividseats.manager.EventManager;
...
public class EventListFragment extends Fragment implements IResponseHandler {
    ...
    public void processResponse(String action, JSONObject response) {
        ...
        if (response != null) {
            if (action.equals(RequestConstants.ACTION_LOAD)) {
                List<Event> events = EventManager.parseEvents(response);
    ...
    private void setup(List<Event> events) {
        ...
        mAdapter = new EventListAdapter(this.getActivity(), events);
